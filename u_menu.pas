...
begin
  try
    ...
    FreeAndNil(frm_con_cad_denuncia);
  end;
end;
...
begin
  try
    ...
    FreeAndNil(frm_cad_fiscalizacao);
  end;
end;
...
begin
  try
    ...
    FreeAndNil(frm_con_cad_fiscalizacao);
  end;
end;
...
begin
  try
    ...
    FreeAndNil(frm_con_cad_lic_amb);
  end;
end;
...
begin
  try
    ...
    FreeAndNil(frm_con_cad_lic_rural);
  end;
end;
